...
class CellContent extends StatelessWidget {
  ...
  final bool isWeekendAndisOutside; // 추가
  final bool isSelectedAndisWeekend; //추가
  ...
  const CellContent({
    ...
    required this.isWeekendAndisOutside, //추가
    required this.isSelectedAndisWeekend, //추가
    this.locale,
  }) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    } else if (isSelectedAndisWeekend) {
      // 추가
