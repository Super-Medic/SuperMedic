  ...
  Widget _buildCell(DateTime day, DateTime focusedDay) {
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        final isSelected = widget.selectedDayPredicate?.call(day) ?? false; //추가
        final isWeekendAndisOutside =
            (isWeekend == true && isOutside == true) ? true : false; // 추가
        final isSelectedAndisWeekend =
            (isWeekend == true && isSelected == true) ? true : false; // 추가
        Widget content = CellContent(
          ...
          isToday: isToday,
          isSelected: isSelected, // 변경
          isRangeStart: isRangeStart,
          isRangeEnd: isRangeEnd,
          isWithinRange: isWithinRange,
          isOutside: isOutside,
          isDisabled: isDisabled,
          isWeekendAndisOutside: isWeekendAndisOutside, // 추가
          isSelectedAndisWeekend: isSelectedAndisWeekend, // 추가
          isWeekend: isWeekend,
